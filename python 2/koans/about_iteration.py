...
class AboutIteration(Koan):
    ...
    def test_reduce_will_blow_your_mind(self):
        ...
        # Reduce applies the supplied function left-to-right on the
        # supplied list, accumulating the result as a single variable.
        # The third argument is placed before the other arguments and is
